...
@section('content')
    <div class="flex flex-col items-start px-20 mt-20 w-full max-md:px-5 max-md:mt-10 pt-20">
            ...
            <div class="w-1/3 max-md:w-full mt-6 md:mt-0">
                <div class="bg-yellow-50 rounded-3xl p-6 sm:p-5 shadow-sm">
                    ...
                    <div class="flex gap-4 mt-4 items-center">
                        ...
                        <div>Post Name: <span class="text-sm">UI Designer</span></div>
                    </div>
                    <div class="flex gap-4 mt-4 items-center">
                        ...
                        <div>Qualification: <span class="text-sm ">10th Pass or ITI</span></div>
                    </div>
                    <div class="flex gap-4 mt-4 items-center">
                        ...
                        <div>Age Limit: <span class="text-sm">19-36 Years</span></div>
                    </div>
                    <div class="flex gap-4 mt-4 items-center">
                        ...
                        <div>Monthly Salary: <span class="text-sm">24,200- 54,000 Rs/-</span></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Notification Button -->
        <a href="#"
            class="mt-10 self-center text-white bg-purple-500 rounded-2xl shadow-sm px-4 py-2 text-lg hover:bg-purple-700">For
