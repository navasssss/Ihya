        ...
        <div class="max-w-screen-lg flex flex-wrap items-center justify-between mx-auto px-4 place-content-center my-4">
            ...
            <div class="flex items-center md:order-2 md:space-x-0 rtl:space-x-reverse gap-4 md:gap-10 ">
                ...
                <div class="flex justify-center" style="margin-top: -129px">
                    <div x-data="{ dropdownOpen: true }" class="relative my-32 mb-1 hidden md:flex">
                        <button @click="dropdownOpen = !dropdownOpen"
                ...
                <ul
                    ...
                    <li>
                        <a href="{{ route('jobs.index') }}"
                            class="block py-2 px-3 font-semibold text-lg text-[#d36c32]" aria-current="page">Jobs</a>
                    </li>
                    <li>
                        <a href="#"
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#d39c32] md:p-0 border-sm:border-b-2 border-gray-200 text-lg">Community</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#d39c32] md:p-0 border-sm:border-b-2 border-gray-200 text-lg">Set
                            career</a>
                    </li>
                </ul>
            </div>
